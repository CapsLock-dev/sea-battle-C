...
void panel_put_char(Panel panel, TermSizeType relative_x, TermSizeType relative_y, char ch, Color fg, Color bg) {
...
void panel_draw_box(Panel panel, Color fg, Color bg) {
    ...
    panel_put_char(panel, (TermSizeType)(panel.width - 1), (TermSizeType)(panel.height - 1), '+', fg, bg);
}
